            ...
            <div className="">
                ...
                <div className="container py-3">
                    ...
                    <div className="card">
                        ...
                        <i class="fa fa-arrow-right blue-text"></i> La typo générale du site vient de <a href="https://fonts.google.com/" target="_blank">Google Fonts</a>, il s'agit de <a href="https://fonts.google.com/?query=segoe+ui" target="_blank">Segoe UI</a>.</p>
