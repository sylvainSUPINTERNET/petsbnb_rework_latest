                    ...
                    <div className="card-body">
                        <form onSubmit={this.submitRegister}>
                            <div className="ml-5 mr-5 p5 mt-4">
                                ...
                                <input type="text" className={this.state.usernameIsValid === true ? 'form-control' : 'form-control is-invalid'} id="" placeholder="Nom d'utilisateur"
                            ...
                            <div className="ml-5 mr-5 p5 mt-4">
                                ...
                                <input type="email" className={this.state.emailIsValid === true ? 'form-control' : 'form-control is-invalid'} id="" placeholder="Email"
                                       onChange={(ev) => {
                                           this.setState({
                            ...
                            <div className="ml-5 mr-5 p5 mt-4">
                                ...
                                <input type="password" className={this.state.passwordConfirmedIsValid === true ? 'form-control' : 'form-control is-invalid'} id="" placeholder=""
                                       required disabled={this.state.disableInputs}
                                       onChange={(ev) => {
                                           this.setState({
