...
class AnnoncesCreate extends React.Component {
    ...
    onSubmit = async (ev) => {
        ...
        setTimeout( async () => {
            if(this.state.body.title.trim().length === 0 || this.state.body.title.trim().length > 50) {
                flagError = true;
                this.setState({
                    isValidTitle: false
                })
            ...
            if(this.state.body.description.trim().length === 0 || this.state.body.description.trim().length > 600) {
                flagError = true;
                this.setState({
                ...
                <div className="container-fluid mb-4">
                        ...
                        <div className="card">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="invalid-feedback">titre ne peut pas être vide et ne doit pas dépasser 50 caractères</div>
                                </div>
                                <div className="col-sm-6">
                                ...
                                <textarea id="description" rows="1" cols="59"  className={this.state.isValidDescription === true ? 'form-control' : 'form-control is-invalid'} disabled={this.state.disableInput} placeholder="Ex. Je peux garder un chien pendant quelques jours"
                                    ...
                                    <div className="invalid-feedback">description ne peut pas être vide et ne doit pas dépasser 600 caractères</div>
                                </div>
                            </div>
